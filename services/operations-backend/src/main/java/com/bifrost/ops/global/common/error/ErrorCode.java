...
public enum ErrorCode {
    ...
    APPROVAL_NOT_FOUND(60001, HttpStatus.NOT_FOUND),
    APPROVAL_EXPIRED(60002, HttpStatus.GONE),
    APPROVAL_ALREADY_DECIDED(60003, HttpStatus.CONFLICT),
    APPROVAL_ALREADY_USED(60004, HttpStatus.CONFLICT),
    APPROVAL_SCOPE_MISMATCH(60005, HttpStatus.FORBIDDEN),
    CHANGE_TICKET_NOT_FOUND(61001, HttpStatus.NOT_FOUND),
    CHANGE_TICKET_REQUIRED(61002, HttpStatus.FORBIDDEN),
    CHANGE_WINDOW_CLOSED(61003, HttpStatus.FORBIDDEN),
    CHANGE_SCOPE_MISMATCH(61004, HttpStatus.FORBIDDEN),
