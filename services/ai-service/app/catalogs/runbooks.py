...
ROOT_CAUSE_RUNBOOKS: tuple[Runbook, ...] = (
    ...
    Runbook(
        ...
        actions=(
            ...
            RunbookActionTemplate(action_name='pause_pipeline', action_type='workflow_action', risk='medium', description='반복 실패로 downstream noise가 클 때 일시 중지', policy='approval', tool_name=None),
        ),
    ...
    Runbook(
        ...
        actions=(
            ...
            RunbookActionTemplate(action_name='pause_pipeline', action_type='workflow_action', risk='medium', description='잘못된 데이터 확산 방지', policy='approval', tool_name=None),
            RunbookActionTemplate(action_name='rollback_pipeline', action_type='workflow_action', risk='high', description='schema 변경 또는 배포 rollback', policy='change_management', tool_name=None),
        ),
    ...
    Runbook(
        ...
        actions=(
            ...
            RunbookActionTemplate(action_name='scale_consumer_deployment', action_type='workflow_action', risk='medium', description='consumer replica 증가', policy='approval', tool_name=None),
            RunbookActionTemplate(action_name='create_rebalance_proposal', action_type='workflow_action', risk='medium', description='broker imbalance가 동반될 때 proposal 생성', policy='approval', tool_name=None),
            RunbookActionTemplate(action_name='pause_low_priority_pipeline', action_type='composite_action', risk='medium', description='중요도가 낮은 pipeline 일시 중지', policy='approval', tool_name=None),
        ),
        forbidden_actions=(),
    ),
    Runbook(
        ...
        actions=(
            ...
            RunbookActionTemplate(action_name='create_rebalance_proposal', action_type='workflow_action', risk='medium', description='Cruise Control proposal 생성', policy='approval', tool_name=None),
            RunbookActionTemplate(action_name='approve_rebalance', action_type='workflow_action', risk='medium', description='proposal 승인', policy='approval', tool_name=None),
    ...
    Runbook(
        ...
        actions=(
            ...
            RunbookActionTemplate(action_name='pause_connector', action_type='runtime_tool', risk='medium', description='sink 보호를 위해 write 중단', policy='approval', tool_name='pause_connector'),
            RunbookActionTemplate(action_name='resume_connector', action_type='runtime_tool', risk='medium', description='sink 회복 후 재개', policy='approval', tool_name='resume_connector'),
    ...
    Runbook(
        ...
        actions=(
            RunbookActionTemplate(action_name='reduce_pipeline_pressure', action_type='composite_action', risk='medium', description='비긴급 pipeline 일시 중지 또는 rate 완화', policy='approval', tool_name=None),
            RunbookActionTemplate(action_name='pause_connector', action_type='runtime_tool', risk='medium', description='sink 보호', policy='approval', tool_name='pause_connector'),
    ...
    Runbook(
        ...
        actions=(
            ...
            RunbookActionTemplate(action_name='scale_consumer_deployment', action_type='workflow_action', risk='medium', description='처리 병렬화로 pod pressure 완화', policy='approval', tool_name=None),
            RunbookActionTemplate(action_name='rollback_pipeline', action_type='workflow_action', risk='high', description='배포 이후 OOM이면 rollback', policy='change_management', tool_name=None),
        ),
    ...
    Runbook(
        ...
        actions=(
            ...
            RunbookActionTemplate(action_name='rollback_pipeline', action_type='workflow_action', risk='high', description='문제 배포 rollback', policy='change_management', tool_name=None),
            RunbookActionTemplate(action_name='pause_pipeline', action_type='workflow_action', risk='medium', description='영향 확산 차단', policy='approval', tool_name=None),
        ),
        forbidden_actions=(),
    ),
    Runbook(
