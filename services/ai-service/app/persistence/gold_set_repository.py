        ...
        async with self._get_pool().acquire() as conn:
            await conn.execute(
                ...
                INSERT INTO rca_gold_set
                    (entry_id, incident_id, accepted_root_cause_id, trigger, symptom,
                     contributing_factors, evidence_ids, human_verdict, labels,
                     review_status, reviewed_by, reviewed_at, created_at)
                VALUES ($1, $2, $3, $4, $5, $6::jsonb, $7::jsonb, $8, $9::jsonb, $10, $11, $12, $13)
                """,
                entry.entry_id,
                entry.incident_id,
