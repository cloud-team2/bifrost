---
doc_id: ops_doc:agent-principles
doc_type: ops_doc
title: FastAPI Agent — Agent Principles (§1)
tags: [ops, agent, principles]
source: curated
---
...
RCA Agent는 [§8 Root Cause Catalog](catalog/catalog-root-causes.md#8-catalog-root-cause)에 정의된 후보만 선택한다. catalog에 없는 가능성은 `UNKNOWN_WITH_EVIDENCE_GAP`으로 보고한다.
