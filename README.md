<p align="center">
  <img src="services/frontend/public/logo.svg" width="72" alt="Bifrost" />
</p>

<h1 align="center">Bifrost</h1>

<p align="center">데이터베이스를 등록하면 CDC/EDA 파이프라인을 구성하고, 운영 중 발생하는 장애 신호를 evidence 기반 AI Agent가 진단하는 DataOps/AIOps 플랫폼</p>
...
<p align="center">
  ...
  <br/>
  <sub>운영 콘솔 — 파이프라인 상태와 AI Agent 인시던트 패널</sub>
</p>
...
<table>
<tr>
<td width="50%"><img src="docs/test/assets/live-02-rca.png" alt="evidence 기반 RCA" /></td>
<td width="50%"><img src="docs/test/assets/live-03-actions.png" alt="승인 기반 조치 후보" /></td>
</tr>
<tr>
<td><sub><b>evidence 기반 RCA</b> — confidence와 근거가 부족하면 <code>UNKNOWN_WITH_EVIDENCE_GAP</code>으로 보류하고 추가 evidence를 요구</sub></td>
<td><sub><b>조치 후보</b> — 위험도(낮음·중간)와 승인 상태, 근거 리포트를 함께 제시하고 실행은 <code>/internal/ops</code> 경계를 통과</sub></td>
</tr>
</table>
