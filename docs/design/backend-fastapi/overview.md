...
> 지연 최소화(병렬 read·부분 스트리밍·tier 분리)·severity 2단계·RCA→incident 기록 등 상세는 [contracts.md](./contracts.md)·[principles.md](./principles.md).
...
- 저장소 ERD·테이블 상세는 [principles.md §2 Server Design §9](./principles.md#2-server-design).
